...
RUN cargo build --release -p w9-homepage-server &&     cp target/release/w9-homepage-server /usr/local/bin/appserver &&     chmod +x /usr/local/bin/appserver &&     ls -la /usr/local/bin/appserver
